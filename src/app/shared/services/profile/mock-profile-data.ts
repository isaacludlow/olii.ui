    ...
    SavedImageAlbumPreviews: [
      {
        ...
        Title: 'My Photos', Description: 'Personal photos that mean a lot to you.', PrivacyLevel: PrivacyLevelRequest.Private,
        ImageUrls: [
      ...
      },
      {
        ...
        Title: 'Saved Photos', Description: 'All your random pics from things you don\'t want to lose track of.', PrivacyLevel: PrivacyLevelRequest.Public,
        ImageUrls: [
